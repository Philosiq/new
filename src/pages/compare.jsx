          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-3">
            <button
              onClick={async () => {
                ...
                await Promise.all([loadLeft(leftId), loadRight(rightCode)]);
              }}
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-6">
              {compareAxes.map((ax) => {
                ...
                const leftDominant =
                  leftPercent > 50 ? ax.leftLabel : ax.rightLabel;
                const rightDominant =
                  rightPercent > 50 ? ax.leftLabel : ax.rightLabel;
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div
                          className={`text-sm font-medium ${alignmentColor} flex items-center gap-1`}
                        >
                      ...
                      <div className="text-sm text-gray-600">
                        <span className="font-medium">{ax.leftLabel}</span> vs{" "}
                        <span className="font-medium">{ax.rightLabel}</span>
                        {difference > 0 && (
                                ...
                                <span
                                  className={`px-2 py-0.5 rounded-full text-white ${
                                    ax.name === "Equity vs. Free Market"
                                      ...
                                      ? "bg-sky-500"
                                      : ax.name === "Secular vs. Religious"
                                      ? "bg-yellow-400"
                                      : ax.name === "Globalism vs. Nationalism"
                                      ? "bg-lime-500"
                                      : "bg-blue-600"
                                  }`}
                                >
                              ...
                              <div
                                className={`absolute inset-0 ${
                                  ax.name === "Equity vs. Free Market"
                                    ...
                                    : ax.name ===
                                      "Libertarian vs. Authoritarian"
                                    ? "bg-gradient-to-r from-teal-500 via-gray-300 to-orange-500"
                                    : ax.name === "Progressive vs. Conservative"
                                    ? "bg-gradient-to-r from-sky-500 via-gray-300 to-red-400"
                                    : ax.name === "Secular vs. Religious"
                                    ? "bg-gradient-to-r from-yellow-400 via-gray-300 to-purple-500"
                                    : ax.name === "Globalism vs. Nationalism"
                                    ? "bg-gradient-to-r from-lime-500 via-gray-300 to-rose-500"
                                    : "bg-gradient-to-r from-blue-600 via-gray-300 to-green-600"
                                }`}
                              ></div>
                          ...
                          {ax.left !== null ? (
                            <div className="space-y-2">
                              ...
                              <div className="text-sm text-blue-700 space-y-1">
                                <div>
                                  <strong>{ax.left}%</strong> {ax.leftLabel}
                                </div>
                                <div>
                                  <strong>{100 - ax.left}%</strong>{" "}
                                  {ax.rightLabel}
                                </div>
                              </div>
                              <div className="text-sm text-blue-700">
                                ...
                                <strong>
                                  {leftPercent > 50
                                    ? Math.round((leftPercent - 50) * 2)
                                    : Math.round((50 - leftPercent) * 2)}
                                  %
                                </strong>{" "}
                                {leftDominant}
                              </div>
                          ...
                          {ax.right !== null ? (
                            <div className="space-y-2">
                              ...
                              <div className="text-sm text-indigo-700 space-y-1">
                                <div>
                                  <strong>{ax.right}%</strong> {ax.leftLabel}
                                </div>
                                <div>
                                  <strong>{100 - ax.right}%</strong>{" "}
                                  {ax.rightLabel}
                                </div>
                              </div>
                              <div className="text-sm text-indigo-700">
                                ...
                                <strong>
                                  {rightPercent > 50
                                    ? Math.round((rightPercent - 50) * 2)
                                    : Math.round((50 - rightPercent) * 2)}
                                  %
                                </strong>{" "}
                                {rightDominant}
                              </div>
            ...
            <div className="mt-8">
              ...
              <p className="text-center text-gray-600 mb-8">
                Review your answers and your friend's answers for each question,
                organized by political axis
              </p>
              ...
              rightResult?.rawData?.answers ? (
                <div className="space-y-12">
                  {compareAxes.map((axis) => {
                    ...
                    return (
                      <div key={axis.name} className="relative overflow-hidden">
                        {/* Background Pattern */}
                        ...
                        <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                          ...
                          <div className="p-10 space-y-10">
                            {Array.from(
                              ...
                              const leftContext =
                                leftResult.rawData.contextTexts?.[questionId] ||
                                "";
                              const rightContext =
